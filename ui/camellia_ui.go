...
func (this *UICamelliaMainWindow) SetupUI(MainWindow *widgets.QMainWindow) {
	...
	this.KeyEdit.SetGeometry(core.NewQRect4(150, 230, 291, 41))
	...
	this.Label.SetGeometry(core.NewQRect4(30, 230, 81, 21))
	this.EncryptedText = widgets.NewQTextEdit(this.Centralwidget)
	this.EncryptedText.SetObjectName("EncryptedText")
	this.EncryptedText.SetGeometry(core.NewQRect4(150, 348, 291, 81))
	...
	this.Label6.SetGeometry(core.NewQRect4(30, 310, 101, 21))
